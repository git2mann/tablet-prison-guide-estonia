...
import activitiesStill from '../../assets/categories/activities/activities_still.png';
import activitiesLoop from '../../assets/categories/activities/activities_loop.mp4';
...
export default {
  ...
  imageUrl: activitiesStill,
  videoUrl: activitiesLoop,
  videoPosition: '50% 0%',
  videoTranslateY: '8%',
  color: 'purple',
  articles: [
